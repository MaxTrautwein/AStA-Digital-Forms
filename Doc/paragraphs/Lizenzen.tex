...
\begin{itemize}
    ...
    \item Weitergabe
    \item Anpassung
    \item Patentnutzung % Nach meinem Verständnis schützt es vor Royalty Zahlungs Anforderungen
    \item private Nutzung und Modifikation
\end{itemize}
...
Die GNU GPL V2 ist die Vorgängerversion der GNU GPLv3 siehe \refk{sec:gnu-gplv3}.
Wie schon dort beschrieben hat die V2 einige Probleme, welche mit der V3 behoben wurden.

Abgesehen davon wird hier noch zusätzlich die Classpath Exception verwendet.
