...
\begin{longtable}{|lr|}
    ...
    \\und Verifikation auf allen Team Systemen}
    ...
    \trschaetzung{Interviews Fragen}{4.5}{Interviewfragen an die verschiedenen Stakeholder.}
    \trschaetzung{Interviews Durchführen}{6}{Interviews werden durchgeführt und protokolliert}
    \trschaetzung{User Storys entwerfen}{9}{Userstorys entwickeln}
