...
\begin{longtable}{|lr|}
    ...
    \trschaetzung{Keycloak Anmeldung Frontend}{6}{Management im Frontend um einen \ac{JWT} Token von Keycloak, für den Nutzer zu erhalten}
    \trschaetzung{Keycloak Verifikation}{6}{Backend Logik um den \ac{JWT} Token zu verifizieren und einem Nutzer zuzuordnen}
