...
\begin{figure}[H]
    \includegraphics[width=15cm, height=19cm]{Doc/images/Fill in Form Sequence Diagramm part 1.png}
    \caption{Antrag ausfüllen Diagramm Teil 1}\label{fig:Antrag Flow 1}
\end{figure}   
\begin{figure}[H]
    \includegraphics[width=15cm]{Doc/images/Fill in Form Sequence Diagramm part 2.png}
