...
% \trWork{Title}{-}{Time}{-}{\gitIssue{1} \\ \gitPull{2}}{-}
    \begin{longtable}{|llll|}
        ...
        \endhead
        \trWork{Repo Init}{Init}{1h 5min}{-}{\gitIssue{1} \\ \gitPull{2}}{-}

        \trWork{Documentation prep Milestone 1}{Doku}{30min}{-}{\gitIssue{3} \\ \gitPull{4}}{-}
        \trWork{Doku - Randbedingungen}{Doku}{1h 15min}{-}{\gitIssue{6} \\ \gitPull{15}}{-}
        \trWork{Doku \& Planung - Funktionsumfang \\ \& Aufwandsschätzung}{Doku}{6h}{-}{\gitIssue{7} \\ \gitPull{16}}{-}
        \trWork{Doku \& Planung - Architektur}{Doku}{5h 30min}{-}{\gitIssue{9} \\ \gitPull{12}}{-}
        \trWork{Allgemeine Anpassungen Doku}{Doku}{1h}{-}{\gitIssue{18} \\ \gitPull{21}}{-}
        \trWork{Präsentation Vorbereiten}{Doku}{3h}{-}{\gitIssue{22}}{-}
        \trWork{Docker Compose Setup}{NF-\ref{subsec:dockerized} }{5h 30 min}{-}{\gitIssue{24} \\ \gitPull{31}}{-}
        \trWork{Interviews}{NF-\ref{subsec:bedienung/layout}}{30min}{-}{\gitIssue{27}}{-}
        \trWork{Doku 2 Technologien \& Frameworks}{Doku}{5h 30min}{-}{\gitIssue{28} \\ \gitPull{41}}{-}
        \trWork{Doku 2 Datenbankmodell}{Doku}{1h}{-}{\gitIssue{29} \\ \gitPull{40}}{-}
        % Alternativ könnte das auch auf Docker linken
        \trWork{Setup Keycloak Deployment}{NF-\ref{subsec:technologie}}{45min}{-}{\gitIssue{32}}{-}
...
\begin{longtable}{|llll|}
    ...
    \trWork{Doku \& Planung - Funktionsumfang\\ \& Aufwandsschätzung}{Doku}{2h}{-}{\gitIssue{7}}{-}
    \trWork{Doku - Projektmanagement}{Doku}{4h}{-}{\gitIssue{8} \\ \gitPull{13}}{-}
    \trWork{Präsentation Vorbereiten}{Doku}{4h}{-}{\gitIssue{22}}{-}
    \trWork{Interviews Vorbereiten}{NF-\ref{subsec:bedienung/layout}}{1h}{-}{\gitIssue{26}}{-}
    \trWork{Interviews}{NF-\ref{subsec:bedienung/layout}}{30min}{-}{\gitIssue{27}}{-}
    \trWork{Login Implementiren}{F-\ref{subsec:login}}{20h 30min}{-}{\gitIssue{48} \\ \gitPull{55}}{-}
