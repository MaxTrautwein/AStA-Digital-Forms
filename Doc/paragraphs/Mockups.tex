...
des Frontends zu vermitteln. %eventuell etwas umgangssprachlich schaffen -> vermitteln?%
...
über die integrierten \ac{API}s ist möglich, wie in \refa{Reisekostenhelfer} am Beispiel eines Reisekostenantrags zu sehen ist.
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{Login_Page}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{Landing_Page}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{Own_Data}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{Own_Antraege}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{Fill_in_Antrag}
