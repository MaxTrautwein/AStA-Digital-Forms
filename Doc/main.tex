...
\DeclareAcronym{AStA}{short=AStA,long=Allgemeine Studierendenausschuss}
...
\DeclareAcronym{CORS}{short=CORS,long=Cross-Origin Resource Sharing}
...
\begin{document}
   ...
   \include{paragraphs/Einfuerung}
   \include{paragraphs/Randbedingungen}
   \include{paragraphs/Funktionsumfang}
   \include{paragraphs/Userstories}
   \include{paragraphs/Aufwandsschaetzung}
   \include{paragraphs/Projektmanagement}
   \include{paragraphs/Architektur}
   \include{paragraphs/Architekturschichten}
   \include{paragraphs/Techno}
   \include{paragraphs/API}
   \include{paragraphs/Mockups}
   \include{paragraphs/Datenbank}
   \include{paragraphs/Aufteilung}
   \include{paragraphs/Lizenzen}
   \include{paragraphs/ReflektionLernfortschritt}
   \include{paragraphs/ReflektionProjektmanagement}
   \include{paragraphs/Ausblick}
