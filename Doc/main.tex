...
{
   name=Spike,
   description={Ein Spike erlaubt es Teammitglidern sich wärend eines Sprints mit einem Thema
   zu beschäftigen um mehr Kentnis darüber zu erhalten und zukünftige Risiken zu miniemren}
}
